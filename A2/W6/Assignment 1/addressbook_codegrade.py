...
# This function only exists because codegrade required it...
# See my GitHub for how I would actually do this...
def display(data):
...
def merge_contacts():
    ...
    for line in load_json():
        ...
        contact_fullname = f"{contact_firstname} {contact_lastname}"
        ...
        if dict_user_occurrences[key] > 1:
            ...
            for line in load_json():
                ...
                if contact_fullname == key and contact_id != highest_id:
                    ...
                    duplicate_email = line["emails"]
                    duplicate_contact_emails.append(duplicate_email)
                    duplicate_phonenumber = line["phone_numbers"]
                    duplicate_contact_phonenumbers.append(duplicate_phonenumber)
            ...
            for line in load_json():
                ...
                contact_firstname = line["first_name"]
                contact_lastname = line["last_name"]
                if f"{contact_firstname} {contact_lastname}" == key and contact_id == highest_id:
